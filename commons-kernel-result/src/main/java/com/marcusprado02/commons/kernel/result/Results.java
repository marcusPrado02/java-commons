...
public final class Results {
  ...
  /**
   * Unwrap: returns value if Ok, otherwise throws DomainException (with the Problem). Useful in
   * internal layers of the domain/application.
   */
  ...
  /**
   * Unwrap custom: allows mapping the Problem to a specific exception. Ex: (p) -> new
  ...
  /**
   * Executes supplier and catches DomainException to turn into Result.fail. This reduces try/catch
