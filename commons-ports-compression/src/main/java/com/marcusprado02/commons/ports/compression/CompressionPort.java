...
/**
 * Port interface for compression operations. Provides unified abstraction for different compression
 * algorithms.
 *
 * <p>This interface supports both streaming and in-memory compression operations, allowing for
 * flexible usage patterns depending on data size and performance requirements.
 *
 * @author Marcus Prado
 * @since 1.0.0
 */
