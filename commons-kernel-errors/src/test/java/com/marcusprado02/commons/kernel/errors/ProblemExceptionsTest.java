...
class ProblemExceptionsTest {
  ...
  void should_map_validation_to_ValidationException() {
    Problem p =
        Problem.of(
            ErrorCode.of("X.VALIDATION"), ErrorCategory.VALIDATION, Severity.ERROR, "invalid");
  ...
  void should_map_not_found_to_NotFoundException() {
    Problem p =
        Problem.of(ErrorCode.of("X.NOT_FOUND"), ErrorCategory.NOT_FOUND, Severity.ERROR, "missing");
