 ...
 *
 * <p>This implementation provides memory-efficient compression for large datasets by processing
...
public class StreamingCompressionAdapter implements StreamingCompressionPort {
  ...
  @Override
  public Result<StreamingCompressor> createCompressor(
      OutputStream output, CompressionOptions options) {
    ...
    try {
      ...
      logger.error("Failed to create compressor for algorithm {}", options.algorithm());
      return Result.fail(
          Problem.of(
  ...
  @Override
  public Result<StreamingDecompressor> createDecompressor(
      InputStream input, CompressionOptions options) {
    ...
    try {
      ...
      logger.error("Failed to create decompressor for algorithm {}", options.algorithm());
      return Result.fail(
          Problem.of(
              ErrorCode.of("COMPRESSION_CREATION_ERROR"),
              ErrorCategory.TECHNICAL,
  ...
  abstract static class AbstractStreamingCompressor implements StreamingCompressor {
    ...
    protected Problem createIOError(String message, Throwable cause) {
      return Problem.of(
          ErrorCode.of("COMPRESSION_IO_ERROR"), ErrorCategory.TECHNICAL, Severity.ERROR, message);
    }
  }
  ...
  static class GzipStreamingCompressor extends AbstractStreamingCompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing GZIP compressor");
      }
    }
  }
  ...
  static class LZ4StreamingCompressor extends AbstractStreamingCompressor {
    ...
    LZ4StreamingCompressor(OutputStream output, CompressionOptions options, LZ4Factory factory)
        throws IOException {
      super(options);
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing LZ4 compressor");
      }
    }
  }
  ...
  static class DeflateStreamingCompressor extends AbstractStreamingCompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing DEFLATE compressor");
      }
    }
  }
  ...
  static class BrotliStreamingCompressor extends AbstractStreamingCompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing Brotli compressor");
      }
    }
  }
  ...
  static class ZstdStreamingCompressor extends AbstractStreamingCompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing ZSTD compressor");
      }
    }
  }
  ...
  static class SnappyStreamingCompressor extends AbstractStreamingCompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing Snappy compressor");
      }
    }
  }
  ...
  static class GzipStreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing GZIP decompressor");
      }
    }
  }
  ...
  static class LZ4StreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    LZ4StreamingDecompressor(InputStream input, CompressionOptions options, LZ4Factory factory)
        throws IOException {
      super(options);
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing LZ4 decompressor");
      }
    }
  }
  ...
  static class DeflateStreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing DEFLATE decompressor");
      }
    }
  }
  ...
  static class BrotliStreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing Brotli decompressor");
      }
    }
  }
  ...
  static class ZstdStreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing ZSTD decompressor");
      }
    }
  }
  ...
  static class SnappyStreamingDecompressor extends AbstractStreamingDecompressor {
    ...
    protected void closeInternal() {
      try {
        ...
        logger.warn("Error closing Snappy decompressor");
      }
    }
  }
}
